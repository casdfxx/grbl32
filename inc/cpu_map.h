...
#define STEPPERS_DISABLE_MASK   (1<<STEPPERS_DISABLE_BIT)
#define SetStepperDisableBit()    GPIO_SetBits(STEPPERS_DISABLE_PORT,STEPPERS_DISABLE_MASK)       //½ûÓÃ²½½øµç»ú
#define ResetStepperDisableBit()  GPIO_ResetBits(STEPPERS_DISABLE_PORT,STEPPERS_DISABLE_MASK)     //ÔÊÐí²½½øµç»ú
...
#define SPINDLE_PWM_RANGE         (SPINDLE_PWM_MAX_VALUE-SPINDLE_PWM_MIN_VALUE)
  ...
  //   4      Y_DIRECTION_BIT                       COOLANT_FLOOD_BIT
